...
(3, 'Michael Jordan', 'michael.jordan@example.com', 'hashedPassword3'),
(4, 'Emily Davis', 'emily.davis@example.com', 'hashedPassword4'),
(5, 'Chris Evans', 'chris.evans@example.com', 'hashedPassword5'),
(6, 'Sophia Turner', 'sophia.turner@example.com', 'hashedPassword6'),
(7, 'Oliver Twist', 'oliver.twist@example.com', 'hashedPassword7'),
(8, 'Isabella Rose', 'isabella.rose@example.com', 'hashedPassword8'),
(9, 'Joshua Brown', 'joshua.brown@example.com', 'hashedPassword9'),
(10, 'Chloe Kim', 'chloe.kim@example.com', 'hashedPassword0');

INSERT INTO TRANSACTION (ID, USER_ID, TRANSACTION_DATE, AMOUNT, CURRENCY, TRANSACTION_TYPE) VALUES
